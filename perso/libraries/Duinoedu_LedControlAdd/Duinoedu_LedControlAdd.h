...
// ETIQUETTE PAR DEFAUT
	#define CODE_DE_MOTIFS //do{const byte IMAGES[][8]={{B00000000,B11101001,B10101010,B10101100,B10101010,B11101001,B00000000,B00000000}};const int IMAGES_LEN = sizeof(IMAGES)/8;}while(0)
	#define VIDE
