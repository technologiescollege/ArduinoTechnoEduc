...
#define afficherSur2(val) display(1, val);
#define afficherSur3(val) display(2, val);
#define afficherSur4(val) display(3, val);

#define afficherPoints(void) point(POINT_ON)
#define effacerPoints(void)  point(POINT_OFF)
