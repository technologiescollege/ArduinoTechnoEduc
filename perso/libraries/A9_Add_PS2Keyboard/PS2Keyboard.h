...
/*EDU FR*/ static void brancher(uint8_t dataPin=8, uint8_t irq_pin=5, const PS2Keymap_t &map = PS2Keymap_French);
/*EDU US*/ static void branch(uint8_t dataPin, uint8_t irq_pin, const PS2Keymap_t &map = PS2Keymap_US);
/*ARD US*/ static void begin(uint8_t dataPin, uint8_t irq_pin, const PS2Keymap_t &map = PS2Keymap_US);
    
    /**
     * Returns true if there is a char to be read, false if not.
     */

/*EDU FR*/ //static bool donneDisponible();
/*ARD US*/ static bool available();
     ...
     * 
     */
/*KTM FR*/ char afficher(void); 
/*KTM US*/ char display(void); 
