...
/*EDU US*/	uint8_t		ServoPlus360::brancher	(int pin){return branch(pin);}
/*EDU US*/	uint8_t		ServoPlus360::branch	(int pin){return attach(pin);}
/*EDU US*/	uint8_t		ServoPlus360::attach	(int pin){
	...
	//---- Réglage des valeurs par défaut
		...
		uint16_t centerPointPulse = 1525;				// Point milieu
...
//----- METHODE EFFECTIVE
/*EDU US*/	void 	ServoPlus360::writeMicroseconds	(uint16_t pulseDelay){
// METHODE EFFECTIVE : On écrit directement une largeur d'impultion
	
	servo->writeMicroseconds(pulseDelay);
