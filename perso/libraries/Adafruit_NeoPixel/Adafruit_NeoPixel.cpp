...
/*EDU FR*/	void Adafruit_NeoPixel::brancher(void) {branch();}
/*EDU US*/	void Adafruit_NeoPixel::branch(void) {
	begin();
	clearAll();
}
...
/*EDU FR*/	void Adafruit_NeoPixel::afficher(void) {show();}
...
/*EDU FR*/	void Adafruit_NeoPixel::preparerPixel(uint16_t n, uint32_t c){setPixel(n, c);}//*/
/*EDU US*/	void Adafruit_NeoPixel::setPixel(uint16_t n, uint32_t c){	setPixelColor(n, c);}//*/
...
/*EDU FR*/	void Adafruit_NeoPixel::writePixel(uint16_t n, uint16_t r, uint16_t g, uint16_t b){
	//---- Configuration
		setPixel(n, r, g, b);
	//---- Active
		show();
...
void Adafruit_NeoPixel::ecrireLuminosite(uint16_t b) {
...
/*EDU FR*/  void Adafruit_NeoPixel::effacerTout(void){clearAll();}
/*EDU US*/  void Adafruit_NeoPixel::clearAll(void){
	//---- On scane toutes les LED actives
		for(uint16_t i=0; i<m_nbrOfLed; i++){
			
			//---On efface le pixel i sur les 3 couleurs
