...
Blockly.Msg.ARDUINO_BASE_COMMENT_TEXT = "commentaire";
...
Blockly.Msg.ARDUINO_BASE_DEFINE_CONST_INPUT1 = "définir la variable";
Blockly.Msg.ARDUINO_BASE_DEFINE_CONST_INPUT2 = "comme étant égal à";
Blockly.Msg.ARDUINO_BASE_DEFINE_CONST_TOOLTIP = "permet de créer et fixer une valeur à une variable, de manière constante";
...
Blockly.Msg.ARDUINO_BASE_INCLUDE_LIB_TEXT = "inclure une bibliothèque";
Blockly.Msg.ARDUINO_BASE_INCLUDE_LIB_TOOLTIP = "permet d'inclure une bibliothèque complémentaire contenue dans le repertoire de travail";
...
Blockly.Msg.ARDUINO_INOUT_STATE ="de l'état";
...
Blockly.Msg.Serial_line="un saut de ligne";
Blockly.Msg.Serial_line_tooltip="permet d'aller à ligne sur le moniteur série";
...
Blockly.Msg.ROBUNO_TEXT14 = "sens horaire (VRAI) ou antihoraire (FAUX)?";
Blockly.Msg.ROBUNO_TEXT15 = "vitesse MAX (255) ou nulle (0)";
...
Blockly.Msg.BLYNK_EMAIL_TITLE = "envoyer un courriel";
...
Blockly.Msg.BLYNK_VIRTUAL_WRITE_TITLE = "envoyer sur la broche virtuelle ";
Blockly.Msg.BLYNK_VIRTUAL_WRITE_TOOLTIP = "";
Blockly.Msg.BLYNK_WRITE_TITLE = "lire sur la Broche Virtuel ";
...
Blockly.Msg.BLYNK_EMAIL_ADDRESS = "adresse";
Blockly.Msg.BLYNK_EMAIL_BODY = "corps";
Blockly.Msg.BLYNK_EMAIL_TITLE_2  = "objet";
...
Blockly.Msg.Peguino_Bodysensor_TEXT = "capteur de mouvement";
Blockly.Msg.Peguino_Bodysensor_TOOLTIP = "Avec cette brique Peguino, les mouvements sont détectés à proximité.";
Blockly.Msg.Peguino_Bodysensor_PLUG = "connecteur";
...
Blockly.Msg.Peguino_ProximityBrick_TEXT = "télémètre à ultrasons : connecteur A";
Blockly.Msg.Peguino_ProximityBrick = "cm oder zoll";
Blockly.Msg.Peguino_ProximityBrick_TOOLTIP = "Cette brique Peguino mesure la distance aux objets, en centimètres. Connecter au connecteur 'A'.";
Blockly.Msg.Peguino_ProximityBrick_HELPURL = "https://www.peguino.com/chat/thread-18.html";

Blockly.Msg.Peguino_ButtonBrick_TEXT = "bouton poussoir";
Blockly.Msg.Peguino_ButtonBrick_TOOLTIP = "Cette brique Peguino est un interrupteur simple : tant qu’elle est enfoncée, le circuit est fermé.";
Blockly.Msg.Peguino_ButtonBrick_INPUT = "connecteur";
...
Blockly.Msg.Peguino_PotiBrick_TEXT = "capteur angulaire (potentiomètre)";
Blockly.Msg.Peguino_PotiBrick_TOOLTIP = "Cette brique Peguino est un potentiomètre : lorsque vous tournez, la résistance électrique change et génère ainsi différentes valeurs numériques.";
Blockly.Msg.Peguino_PotiBrick_PLUG = "connecteur";
...
Blockly.Msg.Peguino_Microprox_TEXT = "capteur de proximité";
Blockly.Msg.Peguino_Microprox_TOOLTIP = "Cette brique Peguino détecte les différences de luminosité sur les surfaces et enregistre de courtes distances par réflexion de la lumière infrarouge.";
Blockly.Msg.Peguino_Microprox_PLUG = "connecteur";
...
Blockly.Msg.Peguino_ClimateBrick_TEXT = "température + humidité";
Blockly.Msg.Peguino_ClimateBrick_TOOLTIP = "Cette brique Peguino fournit des données sur la température mesurée (en ° Celsius) et l’humidité (en %).";
Blockly.Msg.Peguino_ClimateBrick_PLUG = "connecteur";
...
Blockly.Msg.Peguino_ClimateBrick_DHT_READ_C = "Température °C";
Blockly.Msg.Peguino_ClimateBrick_DHT_READ_H = "Humidité %";

Blockly.Msg.PeguinoIRsender_TEXT = "émetteur infrarouge IR";
Blockly.Msg.PeguinoIRsender_INPUT1 = "connecteur";
Blockly.Msg.PeguinoIRsender_INPUT2 = "fréquence (Hz) 38000 ";
...
Blockly.Msg.PeguinoIRreceiver_TEXT = "récepteur infrarouge IR";
...
Blockly.Msg.Peguino_Lightsensor_TEXT = "capteur de luminosité";
Blockly.Msg.Peguino_Lightsensor_TOOLTIP = "Cette Brique Peguino détecte les différences de luminosité.";
Blockly.Msg.Peguino_Lightsensor_PLUG = "connecteur";
...
Blockly.Msg.Peguino_BuzzerBrick_TEXT = "avertisseur sonore (Buzzer)";
Blockly.Msg.Peguino_BuzzerBrick_TOOLTIP = "cette brique Peguino fait des bruits simples.";
Blockly.Msg.Peguino_BuzzerBrick_PLUG = "connecteur";
Blockly.Msg.Peguino_BuzzerBrick_UNIT = "port";
Blockly.Msg.Peguino_BuzzerBrick_FREQUENCY = "son";
...
Blockly.Msg.Peguino_BuzzerBrick_FREQUENCY_VALUE = "fréquence";
Blockly.Msg.Peguino_BuzzerBrick_PLAYTIME = "durée";
Blockly.Msg.Peguino_BuzzerBrick_PLAYTIME_CHOICE = [["?", "0"], ["0,2 secondes", "200"], ["0,5 secondes", "500"],  ["1 seconde", "1000"]];
Blockly.Msg.Peguino_BuzzerBrick_PLAYTIME_UNIT  = "seconde";
...
Blockly.Msg.Peguino_LED_TEXT = "DEL";
Blockly.Msg.Peguino_LED_INPUT = "connecteur";
...
Blockly.Msg.Peguino_LED_TOOLTIP = "Ce dispositif génère de la lumière : en fonction du type de LED, par ex. en blanc, orange, rose, bleu ou une autre couleur.";
Blockly.Msg.Peguino_LED_HELPURL = "https://www.peguino.com/chat/";

Blockly.Msg.Peguino_RGBLED_TEXT = "DEL multicolore";
Blockly.Msg.Peguino_RGBLED_UNIT = "port";
Blockly.Msg.Peguino_RGBLED_STATUS = "status";
Blockly.Msg.Peguino_RGBLED_INPUT = "broche";
Blockly.Msg.Peguino_RGBLED_RGBCOLOR = "choisir une couleur:";
Blockly.Msg.Peguino_RGBLED_RGBCOLORVALUE = "valeurs";
Blockly.Msg.Peguino_RGBLED_RGBRED = "rouge";
Blockly.Msg.Peguino_RGBLED_RGBGREEN = "vert";
Blockly.Msg.Peguino_RGBLED_RGBBLUE = "bleu";
Blockly.Msg.Peguino_RGBLED_TOOLTIP = "Ce bloc génère de la lumière (sur le port F) de différentes couleurs. La couleur peut être obtenue grâce aux trois couleurs de base : rouge, vert et bleu.";
Blockly.Msg.Peguino_RGBLED_HELPURL = "https://www.peguino.com/chat/thread-19.html";

Blockly.Msg.Peguino_I2CScan_TEXT = "I2C scanner d'adresse : connecteur B";
Blockly.Msg.Peguino_I2CScan_TOOLTIP = "Cet élément permet au bus de données I2C sur le Connecteur B d’être analysé pour rechercher les adresses de périphérique connectés. Les adresses trouvées sont envoyées à l'interface série.";
Blockly.Msg.Peguino_I2CScan_HELPURL = "https://www.peguino.com/chat/thread-20.html";

Blockly.Msg.Peguino_AttachServo_TEXT = "attacher un servomoteur";
Blockly.Msg.Peguino_AttachServo_TOOLTIP = "Ce module est utilisé pour connecter un servomoteur.";
Blockly.Msg.Peguino_AttachServo_PLUG = "sur le connecteur";
...
//////////////////////////// Virtuino 08/05/2020 ////////////////////////////
Blockly.Msg.VIRTUINO_INIT_TEXT = "initialisation de la connexion :";
Blockly.Msg.VIRTUINO_INIT_RX = "Broche RX";
Blockly.Msg.VIRTUINO_INIT_TX = "Broche TX";
...
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT1 = "jouer un son sur le buzzer";
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT2 = "fréquence";
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT3 = "scale";
Blockly.Msg.GROVE_BK_OUT_BUZZER_TEXT4 = "durée";
Blockly.Msg.GROVE_BK_OLED_TEXT1 = "écrire sur l'écran OLED";
Blockly.Msg.GROVE_BK_OLED_TEXT2 = "information (texte ou nombre)";
Blockly.Msg.GROVE_BK_OLED_TEXT3 = "ligne (0~3)";
Blockly.Msg.GROVE_BK_OLED_TEXT4 = "colonne (0~15)";
Blockly.Msg.GROVE_BK_OLED_TEXT5 = "rafraîchissement";
...
Blockly.Msg.GROVE_BK_OLED_TOOLTIP = 'affichage sur l\'écran OLED';
...
Blockly.Msg.GROVE_BK_INOUT_PRESSURE_TEXT = 'valeur';
Blockly.Msg.GROVE_BK_INOUT_PRESSURE_TEXT_T = 'de température mesurée (°C)';
Blockly.Msg.GROVE_BK_INOUT_PRESSURE_TEXT_P = 'de pression mesurée (Pa)';
Blockly.Msg.GROVE_BK_INOUT_PRESSURE_TEXT_A = 'd\'altitude calculée (m)';
Blockly.Msg.GROVE_BK_INOUT_PRESSURE_TOOLTIP = 'donne la valeur mesurée de température et de pression, et en calcule l\'altitude';
Blockly.Msg.GROVE_BK_INOUT_GYRO_TEXT1 = 'valeur de l\'accélération';
Blockly.Msg.GROVE_BK_INOUT_GYRO_TEXT2 = 'sur l\'axe';
Blockly.Msg.GROVE_BK_INOUT_GYRO_TOOLTIP = "renvoie les valeurs d\'accélération dans les 3 dimensions";


//////////////////////////// Stendhal school specific blocks 10/09//2020 ////////////////////////////
Blockly.Msg.STENDHAL_INOUT_DHT_HELPURL = "https://github.com/adafruit/DHT-sensor-library";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_C = "de la température °C";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_F = "de la température °F";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_H = "du % d'humidité";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_PIN = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_SENSOR = "mesurée par le capteur air";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_TOOLTIP = "les capteurs de type DHT comportent 2 parties : thermistance et capteur d'humidité.";
Blockly.Msg.STENDHAL_INOUT_DHT_READ_TYPE = "la mesure";
Blockly.Msg.STENDHAL_INOUT_LED_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_LED_INPUT1 = "la LED";
Blockly.Msg.STENDHAL_INOUT_LED_INPUT2 = "qui est connectée sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_LED_INPUT3 = "à l'état";
Blockly.Msg.STENDHAL_INOUT_LED_TOOLTIP = "active la sortie logique sur laquelle la LED est branchée";
Blockly.Msg.STENDHAL_INOUT_BUTTON_HELPURL = "https://openclassrooms.com/courses/programmez-vos-premiers-montages-avec-arduino/les-capteurs-electroniques";
Blockly.Msg.STENDHAL_INOUT_BUTTON_TEXT = "l'état du bouton poussoir";
Blockly.Msg.STENDHAL_INOUT_BUTTON_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_BUTTON_TOOLTIP = "capteur logique, renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_TACTILE_HELPURL = "https://openclassrooms.com/courses/programmez-vos-premiers-montages-avec-arduino/les-capteurs-electroniques";
Blockly.Msg.STENDHAL_INOUT_TACTILE_TEXT = "l'état du bouton tactile";
Blockly.Msg.STENDHAL_INOUT_TACTILE_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_TACTILE_TOOLTIP = "capteur logique, renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_HELPURL = "http://microcontrollerslab.com/reed-switch-arduino-field-dectection/";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_TEXT = "l'état du détecteur d'aimant";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_MAGNETSENSOR_TOOLTIP = "capteur logique, renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_HELPURL = "https://openclassrooms.com/courses/programmez-vos-premiers-montages-avec-arduino/les-capteurs-electroniques";
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_TEXT = "l'état du capteur de choc";
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_TITLSENSOR_TOOLTIP = "capteur logique, le bloc renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_TEXT = "la valeur analogique du capteur d'angle de rotation";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_ROT_ANGLE_TOOLTIP = "capteur analogique, le bloc renvoie une valeur comprise entre 0 et 1023";
Blockly.Msg.STENDHAL_INOUT_TILT_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_TILT_TEXT = "l'état de l'interrupteur à bascule";
Blockly.Msg.STENDHAL_INOUT_TILT_INPUT = "sur la broche";
Blockly.Msg.STENDHAL_INOUT_TILT_TOOLTIP = "Quand le contacteur n'est pas touché, le circuit est ouvert sinon quand le contacteur touche, le circuit est fermé.";
Blockly.Msg.STENDHAL_INOUT_BUZZER_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_BUZZER_TEXT1 = "le buzzer piezo-électrique";
Blockly.Msg.STENDHAL_INOUT_BUZZER_INPUT = "connecté sur sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_BUZZER_TOOLTIP = "Emet un son quand le buzzer est activé";
Blockly.Msg.STENDHAL_INOUT_RELAY_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_RELAY_TEXT1 = "le relais";
Blockly.Msg.STENDHAL_INOUT_RELAY_INPUT = "qui est connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_RELAY_TOOLTIP = "Le relais est un est un télérupteur, c'est un interrupteur placé dans un circuit de puissance qui est actionné par un signal numérique";
Blockly.Msg.STENDHAL_INOUT_MOSFET_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_MOSFET_TEXT1 = "le transistor MOSFET";
Blockly.Msg.STENDHAL_INOUT_MOSFET_INPUT = "qui est connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_MOSFET_TOOLTIP = "Le transistor MOSFET est un télérupteur, c'est un interrupteur placé dans un circuit de puissance qui est actionné par un signal numérique";
...
Blockly.Msg.STENDHAL_INOUT_MOISTURE_TEXT = "la valeur analogique du capteur de sécheresse du sol";
Blockly.Msg.STENDHAL_INOUT_MOISTURE_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_MOISTURE_TOOLTIP = "capteur analogique, le bloc renvoie une valeur comprise entre 0 et 1023";
Blockly.Msg.STENDHAL_INOUT_SOUND_HELPURL = "http://www.adafruit.com/";
...
Blockly.Msg.STENDHAL_INOUT_PIR_TOOLTIP = "capteur logique, le bloc renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_WATER_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_WATER_TEXT = "l'état du détecteur d'eau";
Blockly.Msg.STENDHAL_INOUT_WATER_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_WATER_TOOLTIP = "capteur logique, le bloc renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_LINE_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_LINE_TEXT = "l'état du suiveur de ligne";
Blockly.Msg.STENDHAL_INOUT_LINE_INPUT = "sur la broche";
Blockly.Msg.STENDHAL_INOUT_LINE_TOOLTIP = "renvoie un état logique en fonction de la couleur, blanc ou noir, détectée";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_TEXT = "la distance mesurée en cm";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_TEXT1 = "par le capteur à ultrasons";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_INPUT1 = "départ du signal (TRIG) sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_INPUT2 = "réception du signal (ECHO) sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_INPUT3 = "vitesse du son dans le milieu (en m/s)";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_UNIT = "unité";
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_UNIT_CHOICE = [["cm", "cm"],  ["inch", "inch"]];
Blockly.Msg.STENDHAL_INOUT_ULTRASONIC_TOOLTIP = "mesure par écho ultrason";
Blockly.Msg.STENDHAL_INOUT_MOTOR_HELPURL = "http://www.adafruit.com/";
Blockly.Msg.STENDHAL_INOUT_MOTOR_TEXT = "moteur sur le shield";
Blockly.Msg.STENDHAL_INOUT_MOTOR_CHOICE = [["stop !", "stop"], ["avance", "forward"], ["à droite", "right"], ["à gauche", "left"], ["recule", "backward"]];
Blockly.Msg.STENDHAL_INOUT_MOTOR_TOOLTIP = "pilote 2 moteurs à courant continu";
Blockly.Msg.STENDHAL_INOUT_RGBLED_HELPURL = "";
Blockly.Msg.STENDHAL_INOUT_RGBLED_TEXT1 = "Connections de la LED RGB :";
Blockly.Msg.STENDHAL_INOUT_RGBLED_PIN1 = "- borne rouge sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_RGBLED_PIN2 = "- borne verte sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_RGBLED_PIN3 = "- borne bleue sur la broche N°";
Blockly.Msg.STENDHAL_INOUT_RGBLED_TEXT2 = "Allumer la LED RGB avec les niveaux :";
Blockly.Msg.STENDHAL_INOUT_RGBLED_COLOR1 = "- pour la lumière rouge";
Blockly.Msg.STENDHAL_INOUT_RGBLED_COLOR2 = "- pour la lumière verte";
Blockly.Msg.STENDHAL_INOUT_RGBLED_COLOR3 = "- pour la lumière bleue";
Blockly.Msg.STENDHAL_INOUT_RGBLED_TOOLTIP = "Connecter sur 3 sorties analogiques (repère ~). Le niveau doit être compris entre 0 et 255";
Blockly.Msg.STENDHAL_LED_RGB_INPUT1 = "Pour la LED RGB";
Blockly.Msg.STENDHAL_LED_RGB_INPUT2 = "la LED ROUGE qui est connectée à la broche N°";
Blockly.Msg.STENDHAL_LED_RGB_INPUT3 = "la LED VERTE qui est connectée à la broche N°";
Blockly.Msg.STENDHAL_LED_RGB_INPUT4 = "la LED BLEUE qui est connectée à la broche N°";
Blockly.Msg.STENDHAL_LED_PWM_HELPURL = "";
Blockly.Msg.STENDHAL_LED_PWM_INPUT1 = "Allumer la LED qui est connectée à la broche N°";
Blockly.Msg.STENDHAL_LED_PWM_INPUT2 = "avec un niveau égal à";
Blockly.Msg.STENDHAL_LED_PWM_TOOLTIP = "Met la sortie analogique à un niveau compris entre 0 et 255";
Blockly.Msg.STENDHAL_INOUT_BT_HELPURL = "http://www.seeedstudio.com/wiki/Grove_-_Serial_Bluetooth";
Blockly.Msg.STENDHAL_INOUT_BT_COMM1 = "liaison Bluetooth";
Blockly.Msg.STENDHAL_INOUT_BT_COMM2 = "sur la broche";
Blockly.Msg.STENDHAL_INOUT_BT_COMM3 = "nom du périphérique";
Blockly.Msg.STENDHAL_INOUT_BT_COMM4 = "code secret";
Blockly.Msg.STENDHAL_INOUT_BT_COMM5 = "envoyer";
Blockly.Msg.STENDHAL_INOUT_BT_COMM6 = "recevoir";
Blockly.Msg.STENDHAL_INOUT_BT_TOOLTIP = "Bluetooth V2.0 + EDR esclave. Supporte un seul esclave par carte";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR1 = "Carte pour 4 moteurs à courant continu";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_DIRECTION = "";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_VITESSE = "avec la vitesse (de 0 à 255)";
Blockly.Msg.STENDHAL_MOTORSHIELD_AVANT = "avancer";
Blockly.Msg.STENDHAL_MOTORSHIELD_ARRIERE = "reculer";
Blockly.Msg.STENDHAL_MOTORSHIELD_STOP = "arrêter";
Blockly.Msg.STENDHAL_MOTORSHIELD_PAP1 = "Carte pour moteur pas-à-pas";
Blockly.Msg.STENDHAL_MOTORSHIELD_CONNECT = "Connecter un moteur sur la broche";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_PPT = "pas par tour";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_RPM = "vitesse (RPM)";
Blockly.Msg.STENDHAL_MOTORSHIELD_MOTOR_NB_PAS = "nombre de pas";
Blockly.Msg.STENDHAL_EMETTEUR_IR_TEXT = "Led Infra rouge IR";
Blockly.Msg.STENDHAL_EMETTEUR_IR_INPUT1 = "émettre un signal Infra Rouge sur la broche";
Blockly.Msg.STENDHAL_EMETTEUR_IR_INPUT2 = "d'une fréquence (Hz) 38000 ";
Blockly.Msg.STENDHAL_EMETTEUR_IR_HELPURL = "https://openclassrooms.com/courses/programmez-vos-premiers-montages-avec-arduino/les-capteurs-electroniques";
Blockly.Msg.STENDHAL_EMETTEUR_IR_TOOLTIP = "Emission d'un signal infra rouge";
Blockly.Msg.STENDHAL_BARRIERE_IR_HELPURL = "https://openclassrooms.com/courses/programmez-vos-premiers-montages-avec-arduino/les-capteurs-electroniques";
Blockly.Msg.STENDHAL_BARRIERE_IR_TEXT = "l'état du capteur de lumière infra-rouge";
Blockly.Msg.STENDHAL_BARRIERE_IR_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_BARRIERE_IR_TOOLTIP = "capteur logique, le bloc renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_OBSTACLE_IR_HELPURL = "https://e.banana-pi.fr/distance/121-module-de-capteur-infrarouge-d-evitement-d-obstacles.html";
Blockly.Msg.STENDHAL_OBSTACLE_IR_TEXT = "l'état du détecteur d'obstacle à lumière infra-rouge";
Blockly.Msg.STENDHAL_OBSTACLE_IR_INPUT = "connecté sur la broche N°";
Blockly.Msg.STENDHAL_OBSTACLE_IR_TOOLTIP = "capteur logique, le bloc renvoie actif(1) ou inactif(0)";
Blockly.Msg.STENDHAL_INOUT_BT_AT_HELPURL = "";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM1 = "liaison Bluetooth";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM2 = "sur la broche";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM3 = "nom du périphérique";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM4 = "code secret";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM5 = "recevoir";
Blockly.Msg.STENDHAL_INOUT_BT_AT_COMM6 = "envoyer";
Blockly.Msg.STENDHAL_INOUT_BT_AT_TOOLTIP = "Bluetooth V3.0 + EDR esclave. Supporte un seul esclave par carte";
Blockly.Msg.STENDHAL_STEPPER_TITLE = "Définir un moteur pas à pas";
Blockly.Msg.STENDHAL_STEPPER_MOTOR = "sous le nom :";
Blockly.Msg.STENDHAL_STEPPER_DEFAULT_NAME = "Moteur_PaP_1";
Blockly.Msg.STENDHAL_STEPPER_DEFAULT_NAME1 = "Moteur_PaP_1";
Blockly.Msg.STENDHAL_STEPPER_PIN1 = "Broche N°1 :";
Blockly.Msg.STENDHAL_STEPPER_PIN2 = "Broche N°2 :";
Blockly.Msg.STENDHAL_STEPPER_PIN3 = "Broche N°3 :";
Blockly.Msg.STENDHAL_STEPPER_PIN4 = "Broche N°4 :";
Blockly.Msg.STENDHAL_STEPPER_SPEED = "Vitesse en tr/min :";
Blockly.Msg.STENDHAL_STEPPER_STEPS = "Nombre de pas par tour :";
Blockly.Msg.STENDHAL_STEPPER_STEP1 = "Faire avancer le";
Blockly.Msg.STENDHAL_STEPPER_STEP2 = "de";
...
Blockly.Msg.CROWTAIL_INOUT_SWITCH_TEXT = "l'état de l'interrupteur";
Blockly.Msg.CROWTAIL_INOUT_TOUCHSENSOR_TEXT = "l'état du capteur tactile";
Blockly.Msg.CROWTAIL_INOUT_VIBRATION_INPUT1 = "mettre le module vibratoire";
...
Blockly.Msg.CROWTAIL_INOUT_FLAME_TEXT = "l'état du capteur de flamme";
Blockly.Msg.CROWTAIL_INOUT_FLAME_INPUT = Blockly.Msg.GROVE_INOUT_BUTTON_INPUT;
Blockly.Msg.CROWTAIL_INOUT_FLAME_TOOLTIP = "renvoie un état logique si le feu est détecté à une certaine distance";
