...
#define SPI_MODE_MASK 0x0C  // CPOL = bit 3, CPHA = bit 2 on SPCR1
#define SPI_CLOCK_MASK 0x03  // SPR1 = bit 1, SPR0 = bit 0 on SPCR1
#define SPI_2XCLOCK_MASK 0x01  // SPI2X = bit 0 on SPSR1
