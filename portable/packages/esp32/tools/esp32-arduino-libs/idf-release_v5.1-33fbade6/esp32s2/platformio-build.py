...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "tool"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "typedef"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "image"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "math"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "nn"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "tvm"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "layer"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "detect"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-dl", "include", "model_zoo"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-tflite-micro", "signal", "micro", "kernels"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-tflite-micro", "signal", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "espressif__esp-tflite-micro", "signal", "src", "kiss_fft_wrappers"),
