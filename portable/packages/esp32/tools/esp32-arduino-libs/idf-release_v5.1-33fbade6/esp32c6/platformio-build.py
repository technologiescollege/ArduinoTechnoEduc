...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "freertos", "esp_additions", "include", "freertos"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "freertos", "esp_additions", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "freertos", "esp_additions", "arch", "riscv", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "deprecated"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "analog_comparator", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "dac", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "gpio", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "gptimer", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "i2c", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "i2s", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "ledc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "mcpwm", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "parlio", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "pcnt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "rmt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "sdio_slave", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "sdmmc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "sigma_delta", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "spi", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "temperature_sensor", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "uart", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "driver", "usb_serial_jtag", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "mesh_core"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "mesh_core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "mesh_core", "storage"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "btc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "mesh_models", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "mesh_models", "client", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "bt", "esp_ble_mesh", "mesh_models", "server", "include"),
