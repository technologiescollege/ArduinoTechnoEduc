#ifndef Duinoedu_DallasTemperature_h
#define Duinoedu_DallasTemperature_h
...
// EDU : modifications : David Souder - souder.d@gmail.com
// Date de dernière modification : 16/10/2016
...
class Duinoedu_DallasTemperature
{
public:

	//<<CONSTRUCTOR>>
	Duinoedu_DallasTemperature();

	Duinoedu_DallasTemperature(OneWire*);
	/*EDU US*/	//DeviceAddress sensorDeviceAddress;
	/*EDU US*/	float readTemperatureInDegreesAndReturnFloat();
...
#include <Duinoedu_DallasTemperature.h> //Librairie du capteur


OneWire oneWire(2); //Bus One Wire sur la pin 2 de l'arduino
Duinoedu_DallasTemperature sensors(&oneWire); //Utilistion du bus Onewire pour les capteurs
