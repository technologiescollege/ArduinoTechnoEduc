...
*/
 ...
 /* Version un peu augmentée par David Souder - souder.d@gmail.compare
	pour www.duinoedu.com
	Version du 23/05/2015
	Ajout :
		-Prise en charge des String
		-Prise en charge des nombres entiers
 */
...
const byte CH_MIC         = 7;
/*EDU US*/	const byte CH_TINKERKIT_INA = 8;
/*EDU US*/	const byte CH_TINKERKIT_INB = 9;
...
public:
  ...
  /*EDU US*/
  inline unsigned int readInputA() { return readChannel(CH_TINKERKIT_INA); }
  inline unsigned int readInputB() { return readChannel(CH_TINKERKIT_INB); }
