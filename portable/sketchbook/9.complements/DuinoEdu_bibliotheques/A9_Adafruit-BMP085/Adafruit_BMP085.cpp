...
/*EDU FR*/void Adafruit_BMP085::brancher(){
  //Wire.begin(4, 5);
  if (!begin()) { while (1) {} }	
}
...
/*EDU FR*/ int32_t Adafruit_BMP085::lirePression(void){
	int32_t val = readPressure();
	val = val/100;
return val;
}
...
/*EDU FR*/ float Adafruit_BMP085::lireTemperature(void){
...
/*EDU FR*/ float Adafruit_BMP085::lireAltitude(void){
return readAltitude();
}
